...
rem ============================================================
rem Staged 5-structure runner (unlocked geometry / fixed-gap round)
rem - Total time default: 12 hours = 43200 sec
rem - dx = dy = 0.01
rem - gap fixed at 4.4 um
rem - Stage 1: 3 pure patch structures in parallel
rem             each stops early once "local_opt=1" appears in log
...
rem   - Early-stop behavior for Stage 1 is preserved.
rem ============================================================
...
set "OUT_DIR=%BASE_DIR%\quick_staged_unlock_dx001_%STAMP%"
