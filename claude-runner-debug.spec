...
# Debug build: bootloader debug output, no UPX compression, noarchive for
# readable tracebacks. Output: dist/claude-runner-debug.exe
...
a = Analysis(
    ...
    pathex=[],
    binaries=[],
    datas=[('docker/Dockerfile', 'docker/'), ('projects/examples.yaml', '.'), ('C:\\Users\\20894\\AppData\\Local\\Programs\\Python\\Python311\\Lib\\site-packages\\apprise', 'apprise')],
